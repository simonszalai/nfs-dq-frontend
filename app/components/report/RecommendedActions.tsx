...
export function RecommendedActions({
  ...
  return (
    <div className="mt-8">
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-sm p-8 border border-gray-700">
        <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
          <span className="text-3xl">🧹</span>
          Recommended Actions
        </h2>

        <div className="bg-gray-800/50 rounded-sm p-6 mb-6">
        ...
        {issueStats.critical > 0 && (
          <div className="mt-6 p-4 bg-red-900/20 border border-red-800 rounded-sm">
