...
export function FieldDetailsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative bg-gray-900 rounded-lg p-8 max-w-2xl w-full max-h-[90vh] flex flex-col border border-white/20 shadow-2xl">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        {field.warnings.length > 0 && (
          <div className="bg-white/5 rounded-md p-6 flex flex-col min-h-0">
