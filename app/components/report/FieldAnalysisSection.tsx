    ...
    <>
      <div className="bg-white/10 backdrop-blur-lg rounded-sm p-6 border border-white/20 relative z-20">
        <div className="mb-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2 bg-white/10 border border-white/20 rounded-sm text-white placeholder-gray-400 focus:outline-none focus:border-white/40 focus:bg-white/15 transition-all"
            />
            {searchTerm && (
              <button
        ...
        <div className="mb-6">
          ...
          <div className="h-80 relative bg-white/5 rounded-sm overflow-hidden py-3">
            {chartData.length > 0 ? (
            ...
            {fieldsAlphabetical.map((field) => {
              ...
              return (
                <div
                  ...
                  className="bg-white/5 rounded-sm p-4 hover:bg-white/10 transition-all duration-200 cursor-pointer"
                >
